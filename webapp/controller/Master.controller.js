sap.ui.define([
	...
	return BaseController.extend("Fiori_Northwind_Namespace.Fiori_Northwind.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "Fiori_Northwind_Namespace.Fiori_Northwind.view.ViewSettingsDialog",
					controller: this
