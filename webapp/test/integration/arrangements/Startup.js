sap.ui.define([
	"sap/ui/test/Opa5",
	"Fiori_Northwind_Namespace/Fiori_Northwind/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("Fiori_Northwind_Namespace.Fiori_Northwind.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "Fiori_Northwind_Namespace.Fiori_Northwind",
					async: true
				},
				hash: oOptions.hash,
